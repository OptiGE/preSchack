        ...
        case BABYLON.PointerEventTypes.POINTERDOWN:
            ...
            if (pointerInfo.pickInfo.hit && pointerInfo.pickInfo.pickedMesh) {
                if (xrHelper.baseExperience.state === BABYLON.WebXRState.IN_XR) {
                    // Det här är ett redigt fulhack för att TS är rädd att eventet också kan vara ett WheelEvent. Då kraschar detta.
                    const pointerInfoEvent = pointerInfo.event as PointerEvent; 
